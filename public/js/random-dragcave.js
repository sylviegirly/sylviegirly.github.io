const dragon = ["1DR8g", "1F2mP", "6tVs1", "9VQBX", "5siAi", "3XEgh", "6YnAm", "meQ7x", "b2kCi", "rE148"];
...
const image =
    ...
    randomDragon +
    ".gif' class='image' style='margin-left: auto; margin-right: auto; padding: 10px; margin-bottom: 0' alt='' aria-hidden='true' loading='lazy'/></a>";
