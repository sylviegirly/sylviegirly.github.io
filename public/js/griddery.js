        ...
        if (typeof cols !== "number") {
            if (isNaN(Number(cols))) {
                ...
                if (cols.slice(0, 2) == "--" || cols.slice(0, 6) == "var(--") {
                    let wtCols = getComputedStyle(document.documentElement).getPropertyValue(
                        "--" + cols.split("--").slice(1).join().replaceAll(")", "")
                    );
            ...
            $(gridiv).each(function () {
                $(this)
                    ...
                    .each(function () {
                        ...
                        if (JQversion >= "180") {
                            $(this)
                                .nextUntil(":not(" + gridiv + ")")
                                .addBack()
                                .wrapAll("<div griddery-cont cols='" + gridcols + "'>");
                        } else {
                            $(this)
                                .nextUntil(":not(" + gridiv + ")")
                                .andSelf()
                        ...
                        $(this)
                            ...
                            .each(function () {
                                ...
                                for (smh = 1; smh < gridcols + 1; smh++) {
                                    // assign column IDs
                                    $(this)
                                        .find(gridiv + ":nth-of-type(" + gridcols + "n+" + smh + ")")
                                        .each(function () {
                                    ...
                                    $(this)
                                        .find("[griddery-tr]")
                                        .append("<div griddery-col='" + smh + "'></div>");
                                } //end for loop
                            }); //end container each
