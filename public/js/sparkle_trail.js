// <![CDATA[
var colours=new Array("#b0d6a5", "#b8ce71", "#b8ce71", "#b0d6a5", "#d4dac9"); // colours for top, right, bottom and left borders and background of bubbles
var bubbles=35; // maximum number of bubbles on screen
