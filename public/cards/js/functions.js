...
function cardTextSearch(type) {
    ...
    if (type == "neededcards") {
        ...
        document.getElementById("searchresultcontainer").innerHTML +=
            "<b>future:</b> " + futureFound.length + "<br>" + futureFound.join(", ");
    } else {
        console.log("getting trading cards");

        searchingCards = getTradingCards();

        var tradingFound = searchingCards.filter((card) => {
            return searchArray.some((input) => {
                if (card.startsWith(input) && input != "") {
                    return true;
                }
        ...
        console.log("do trading post result shit");
        document.getElementById("searchresultcontainer").innerHTML = "";
        document.getElementById("searchresultcontainer").innerHTML +=
...
function fillPortfolios() {
    ...
    paletteArray.forEach((deckName) => {
        for (var index = 1; index < 21; index++) {
            ...
            if (keepingCards.includes(deckName + cardNum)) {
                cardsFound += 1;
            }
        }
        if (cardsFound == 20) {
            palettep += "☒ " + deckName + "<br>";
        } else {
            palettep += "☐ " + deckName + "<br>";
        }
        cardsFound = 0;
...
function fillCrayons() {
    ...
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/redcrayon.gif'></div><p><b>" +
        (crayons[0] + addCrayons["red"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/orangecrayon.gif'></div><p><b>" +
        (crayons[1] + addCrayons["orange"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/yellowcrayon.gif'></div><p><b>" +
        (crayons[2] + addCrayons["yellow"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/greencrayon.gif'></div><p><b>" +
        (crayons[3] + addCrayons["green"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/bluecrayon.gif'></div><p><b>" +
        (crayons[4] + addCrayons["blue"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/purplecrayon.gif'></div><p><b>" +
        (crayons[5] + addCrayons["purple"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/browncrayon.gif'></div><p><b>" +
        (crayons[6] + addCrayons["brown"]) +
        "</b></p></div>";
    crayonsHolder.innerHTML +=
        "<div class='crayoncount'><div><img src='currency/graycrayon.gif'></div><p><b>" +
        (crayons[7] + addCrayons["gray"]) +
        "</b></p></div>";
...
function fillTotalCards() {
    ...
    if (totalcards > 14401) {
        ...
        levelString += "chartreux (" + totalcards + " cards)";
    } else if (totalcards > 13201) {
        levelString += "russian blue (" + totalcards + " cards)";
    } else if (totalcards > 12901) {
        levelString += "panther (" + totalcards + " cards)";
    } else if (totalcards > 12601) {
        levelString += "cheetah (" + totalcards + " cards)";
    } else if (totalcards > 12301) {
        levelString += "tiger (" + totalcards + " cards)";
    } else if (totalcards > 12001) {
        levelString += "lion (" + totalcards + " cards)";
    } else if (totalcards > 11701) {
        levelString += "metal (" + totalcards + " cards)";
    } else if (totalcards > 11401) {
        levelString += "ground (" + totalcards + " cards)";
    } else if (totalcards > 11101) {
        levelString += "darkness (" + totalcards + " cards)";
    } else if (totalcards > 10801) {
        levelString += "water (" + totalcards + " cards)";
    } else if (totalcards > 10501) {
        levelString += "nature (" + totalcards + " cards)";
    } else if (totalcards > 10201) {
        levelString += "light (" + totalcards + " cards)";
    } else if (totalcards > 9901) {
        levelString += "wind (" + totalcards + " cards)";
    } else if (totalcards > 9601) {
        levelString += "fire (" + totalcards + " cards)";
    } else if (totalcards > 9301) {
        levelString += "mercury (" + totalcards + " cards)";
    } else if (totalcards > 9001) {
        levelString += "jupiter (" + totalcards + " cards)";
    } else if (totalcards > 8701) {
        levelString += "uranus (" + totalcards + " cards)";
    } else if (totalcards > 8401) {
        levelString += "neptune (" + totalcards + " cards)";
    } else if (totalcards > 8101) {
        levelString += "earth (" + totalcards + " cards)";
    } else if (totalcards > 7801) {
        levelString += "venus (" + totalcards + " cards)";
    } else if (totalcards > 7501) {
        levelString += "saturn (" + totalcards + " cards)";
    } else if (totalcards > 7201) {
        levelString += "mars (" + totalcards + " cards)";
    } else if (totalcards > 6901) {
        levelString += "magnolia (" + totalcards + " cards)";
    } else if (totalcards > 6601) {
        levelString += "chocolate cosmos (" + totalcards + " cards)";
    } else if (totalcards > 6301) {
        levelString += "lilac (" + totalcards + " cards)";
    } else if (totalcards > 6001) {
        levelString += "hydrangea (" + totalcards + " cards)";
    } else if (totalcards > 5701) {
        levelString += "clover (" + totalcards + " cards)";
    } else if (totalcards > 5401) {
        levelString += "daffodil (" + totalcards + " cards)";
    } else if (totalcards > 5101) {
        levelString += "tiger lily (" + totalcards + " cards)";
    } else if (totalcards > 4801) {
        levelString += "sakura (" + totalcards + " cards)";
    } else if (totalcards > 5401) {
        levelString += "silver (" + totalcards + " cards)";
    } else if (totalcards > 4201) {
        levelString += "bronze (" + totalcards + " cards)";
    } else if (totalcards > 3901) {
        levelString += "amethyst (" + totalcards + " cards)";
    } else if (totalcards > 3601) {
        levelString += "sapphire (" + totalcards + " cards)";
    } else if (totalcards > 3301) {
        levelString += "emerald (" + totalcards + " cards)";
    } else if (totalcards > 3001) {
        levelString += "gold (" + totalcards + " cards)";
    } else if (totalcards > 2701) {
        levelString += "amber (" + totalcards + " cards)";
    } else if (totalcards > 2401) {
        levelString += "ruby (" + totalcards + " cards)";
    } else if (totalcards > 2201) {
        levelString += "dragon fruit (" + totalcards + " cards)";
    } else if (totalcards > 2001) {
        levelString += "apricot (" + totalcards + " cards)";
    } else if (totalcards > 1801) {
        levelString += "grape (" + totalcards + " cards)";
    } else if (totalcards > 1601) {
        levelString += "blueberry (" + totalcards + " cards)";
    } else if (totalcards > 1401) {
        levelString += "lime (" + totalcards + " cards)";
    } else if (totalcards > 1201) {
        levelString += "lemon (" + totalcards + " cards)";
    } else if (totalcards > 1001) {
        levelString += "tangerine (" + totalcards + " cards)";
    } else if (totalcards > 801) {
        levelString += "strawberry (" + totalcards + " cards)";
    } else if (totalcards > 701) {
        levelString += "gray (" + totalcards + " cards)";
    } else if (totalcards > 601) {
        levelString += "brown (" + totalcards + " cards)";
    } else if (totalcards > 501) {
        levelString += "purple (" + totalcards + " cards)";
    } else if (totalcards > 401) {
        levelString += "blue (" + totalcards + " cards)";
    } else if (totalcards > 301) {
        levelString += "green (" + totalcards + " cards)";
    } else if (totalcards > 201) {
        levelString += "yellow (" + totalcards + " cards)";
    } else if (totalcards > 101) {
        levelString += "orange (" + totalcards + " cards)";
    } else if (totalcards > 1) {
        levelString += "red (" + totalcards + " cards)";
...
function fillNewCardsContainer(type) {
    ...
    if (type == "keep") {
        cardsFromType = getKeepingCards(false);
    } else if (type == "trading") {
        cardsFromType = getTradingCards(false);
    } else {
...
function readLogs(logData) {
    ...
    var completedSketchpads =
        Math.floor((totalCardsTraded + additionalCurrentSketchpadPoints) / 20) -
        spentSketchpads +
        additionalCompletedSketchpads;
...
function searchShowing() {
    ...
    for (let index = 0; index < cardImages.length; index++) {
        ...
        if (
            ...
            !cardName.includes(searchBarInput) &&
            !cardSeriesName.includes(searchBarInput)
        ) {
            card.style.display = "none";
        }
    }
...
function setCredits() {
    document.getElementById("creditscontainer").innerHTML = `
        <p><a href="https://github.com/leedmitri/neotcg">neotcg</a> by <a href="https://earthslee.neocities.org/">gloomlee</a> / <a href="https://www.deviantart.com/empressofroses/art/Pixel-Bullet-Pastel-Green-798301867">bullet</a> by empressofroses / <a href="https://vgen.co/inlyaart" title="aka it's a commission for me, I'm just using it for a personal sketchbook">sketchbook art commission</a> for me</p>
        `;
}
...
function sortSingleCards() {
    ...
    singleCardsArray.forEach((card) => {
        ...
        cardLinks +=
            '<a href="https://colors-tcg.eu/viewcards.php?deck=' + deckName + '" target="_blank">' + card + "</a>, ";
    });
